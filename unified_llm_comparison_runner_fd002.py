...
# -*- coding: utf-8 -*-
"""
Uniform seeded early-stop benchmark runner for FD002.
...
Notes
-----
- This runner is designed for FD002 only.
...
def feature_cols_fd002(train_df: pd.DataFrame) -> List[str]:
    # Uniform feature set for FD002: operating settings + sensors
    ...
    return [
        {
            "name": "GPT-2",
            "group": "LLM",
            "module_name": "paper1_fd002_attached",
            "filepath": os.path.join(root_dir, "paper1_fd002.py"),
        ...
        },
        {
            "name": "Llama-2-7B",
            "group": "LLM",
            "module_name": "paper2_fd002_attached",
            "filepath": os.path.join(root_dir, "paper2_fd002.py"),
        ...
        },
        {
            "name": "OneFitsAll-FPT",
            "group": "LLM",
            "module_name": "paper3_fd002_attached",
            "filepath": os.path.join(root_dir, "paper3_fd002.py"),
        ...
        },
        {
            "name": "AutoTimes",
            "group": "LLM",
            "module_name": "paper4_fd002_attached",
            "filepath": os.path.join(root_dir, "paper4_fd002.py"),
        ...
        },
        {
            "name": "Qwen2.5-0.5B",
            "group": "LLM",
            "module_name": "paper5_fd002_attached",
            "filepath": os.path.join(root_dir, "paper5_fd002.py"),
        ...
        },
        {
            "name": "Qwen3-0.6B",
            "group": "LLM",
            "module_name": "paper6_fd002_attached",
            "filepath": os.path.join(root_dir, "paper6_fd002.py"),
        ...
        },
        {
            ...
            "module_name": "paper7_fd002",
            "filepath": os.path.join(root_dir, "paper7_fd002.py"),
            "optional": True,
        },
        {
            "name": "GF-CoLLM",
            "group": "Proposed",
            "module_name": "paper8_fd002",
            "filepath": os.path.join(root_dir, "paper8_fd002.py"),
            "optional": True,
        },
    ]
...
def main():
    ...
    parser.add_argument("--out_csv", type=str, default="fd002_uniform_llm_comparison.csv")
    parser.add_argument("--root_dir", type=str, default=".")
    args = parser.parse_args()

    if args.fd.upper() != "FD002":
        raise ValueError("This uniform runner is intended for FD002 only.")

    set_seed(args.seed)
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    train_file = os.path.join(args.data_dir, "train_FD002.txt")
    test_file = os.path.join(args.data_dir, "test_FD002.txt")
    rul_file = os.path.join(args.data_dir, "RUL_FD002.txt")
    ...
    feature_cols = feature_cols_fd002(train_df)
