...
# -*- coding: utf-8 -*-
"""
Qwen3-0.6B-style model for RUL prediction on NASA CMAPSS FD002.
...
Output:
    qwen3_0_6b_fd002_predictions.csv
"""
...
# --------------------------------------------------------------------
# CMAPSS FD002 loading & preprocessing
# --------------------------------------------------------------------
def load_cmapss_fd002(path: str) -> pd.DataFrame:
    """
    Load CMAPSS FD002 file.
...
def main():
    ...
    # Align predictions with RUL_FD002 order
    ...
    out_path = os.path.join(DATA_DIR, "qwen3_0_6b_fd002_predictions.csv")
