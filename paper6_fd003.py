...
# -*- coding: utf-8 -*-
"""
Qwen3-0.6B-style model for RUL prediction on NASA CMAPSS FD003.
...
Output:
    qwen3_0_6b_fd003_predictions.csv
"""
...
# --------------------------------------------------------------------
# CMAPSS FD003 loading & preprocessing
# --------------------------------------------------------------------
...
def load_rul_file(path: str) -> np.ndarray:
    """
    Load RUL_FD003.txt -> array of RUL values, one per test engine.
    """
...
def make_sequences_fd003(df: pd.DataFrame,
                         feature_cols,
                         seq_len_raw: int,
                         use_rul: bool = True):
    """
    Build sequences of fixed length for FD003.
...
def main():
    ...
    # Align predictions with RUL_FD003 order
    ...
    out_path = os.path.join(DATA_DIR, "qwen3_0_6b_fd003_predictions.csv")
