...
# -*- coding: utf-8 -*-
"""
Qwen2.5-0.5B-style model for RUL prediction on NASA CMAPSS FD002.
...
- Saves test predictions to `qwen25_fd002_predictions.csv`.
"""
...
def main():
    ...
    out_path = os.path.join(DATA_DIR, "qwen25_fd002_predictions.csv")
