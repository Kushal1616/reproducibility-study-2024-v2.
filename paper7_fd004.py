...
# -*- coding: utf-8 -*-
"""
CoLLM-C (approximate implementation) on CMAPSS FD004.
...
Output:
- Prints RMSE and MAE on FD004 test set (engine-level evaluation)
"""
...
# CoLLM-C thresholds (you may tune based on FD004 behavior)
TAU1 = 0.6
TAU2 = 0.05
...
def load_rul_file(path: str) -> np.ndarray:
    """
    RUL_FD004.txt -> array of size (#test_units,)
    """
...
def main():
    ...
    # Use 14 informative sensors (same subset as in other FD00x scripts)
    ...
    print("=== Final CoLLM-C Evaluation on FD004 Test ===")
