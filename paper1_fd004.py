...
# -*- coding: utf-8 -*-
"""
GPT-2 fine-tuning for RUL prediction on NASA CMAPSS FD004.
...
Pipeline:
- Load FD004 train/test and build RUL labels for train.
...
- Save test predictions to: gpt2_predictions_FD004.csv
"""
...
def add_rul_labels(train_df):
    """
    Add Remaining Useful Life (RUL) label for each row in FD004 training data:
...
def main():
    ...
    # 13) Prepare test sequences and evaluate on test set using RUL_FD004
    ...
    # FD004 RUL file is assumed to be in ascending unit_id order (1..num_units).
