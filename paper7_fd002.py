...
# -*- coding: utf-8 -*-
"""
CoLLM-C (approximate implementation) on CMAPSS FD002.
...
Output:
- Prints RMSE and MAE on FD002 test set (engine-level evaluation)
"""
...
# CoLLM-C thresholds (you may tune based on paper’s FD002 settings)
TAU1 = 0.6
TAU2 = 0.05
...
def load_rul_file(path: str) -> np.ndarray:
    """
    RUL_FD002.txt -> array of size (#test_units,)
    """
...
def main():
    ...
    # Use 14 informative sensors (same as FD001 version)
    ...
    print("=== Final CoLLM-C Evaluation on FD002 Test ===")
