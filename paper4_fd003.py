...
# -*- coding: utf-8 -*-
"""
AutoTimes-style model for RUL prediction on NASA CMAPSS FD003.
...
- Saves test predictions to `autotimes_fd003_predictions.csv`.
"""
...
def load_cmapss_fd003(path: str) -> pd.DataFrame:
    """
    Load CMAPSS FD003 train/test file.
...
def main():
    ...
    out_path = os.path.join(DATA_DIR, "autotimes_fd003_predictions.csv")
