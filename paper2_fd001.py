...
# -*- coding: utf-8 -*-
"""
Llama-2-7B fine-tuning for RUL prediction on NASA CMAPSS FD001.
...
- This is full fine-tuning of a 7B-parameter model. You will need a large GPU
  or to adapt this to LoRA / 8-bit loading if you hit OOM.
"""
...
# Llama-2-7B HF id (you must have access to this repo)
...
class TimeSeriesLlama2(nn.Module):
    ...
    def forward(self, x):
        ...
        # return in original dtype for consistency
...
def main():
    ...
    # If backbone is in float16, keep optimizer in float32 (default) – fine.
