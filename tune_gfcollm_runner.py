...
def get_feature_cols(train_df, fd=None):
    ...
    - FD002 / FD004: include operating conditions first so the FIG layer can use them explicitly.
    - FD001 / FD003: keep the prior sensor-only behavior.
    """
...
def train_gfcollm_with_schedule(
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        for xb, yb in train_loader:
            ...
            # FD002 schedule: foundation first, then guarded collaboration.
            if epoch <= 25:
                loss = (
                    1.0 * loss_s
                    + 1.0 * loss_l
...
def main():
    ...
    # FD002 stability-first benchmark candidate transferred from FD001 and adapted with condition-aware FIG.
    configs = [
