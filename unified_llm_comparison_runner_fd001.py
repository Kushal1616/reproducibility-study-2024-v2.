...
# -*- coding: utf-8 -*-
"""
Uniform seeded early-stop benchmark runner for FD001.
...
Notes
-----
- This runner is designed for FD001 only.
...
def feature_cols_fd001(train_df: pd.DataFrame) -> List[str]:
    # Uniform feature set for the six attached papers: operating settings + sensors
    ...
    return [
        {
            "name": "GPT-2",
            "group": "LLM",
            "module_name": "paper1_fd001_attached",
            "filepath": os.path.join(root_dir, "Paper1 FD001.py"),
        ...
        },
        {
            "name": "Llama-2-7B",
            "group": "LLM",
            "module_name": "paper2_fd001_attached",
            "filepath": os.path.join(root_dir, "paper2_fd001.py"),
        ...
        },
        {
            "name": "OneFitsAll-FPT",
            "group": "LLM",
            "module_name": "paper3_fd001_attached",
            "filepath": os.path.join(root_dir, "paper3_fd001.py"),
        ...
        },
        {
            "name": "AutoTimes",
            "group": "LLM",
            "module_name": "paper4_fd001_attached",
            "filepath": os.path.join(root_dir, "paper4_fd001.py"),
        ...
        },
        {
            "name": "Qwen2.5-0.5B",
            "group": "LLM",
            "module_name": "paper5_fd001_attached",
            "filepath": os.path.join(root_dir, "paper5_fd001.py"),
        ...
        },
        {
            "name": "Qwen3-0.6B",
            "group": "LLM",
            "module_name": "paper6_fd001_attached",
            "filepath": os.path.join(root_dir, "paper6_fd001.py"),
        ...
        },
        {
            ...
            "module_name": "paper7_fd001",
            "filepath": os.path.join(root_dir, "paper7_fd001.py"),
            "optional": True,
        },
        {
            "name": "GF-CoLLM",
            "group": "Proposed",
            "module_name": "paper8_fd001",
            "filepath": os.path.join(root_dir, "paper8_fd001.py"),
            "optional": True,
        },
    ]
...
def run_collm_methods_with_existing_runner(
    ...
    candidates = [
        ...
        os.path.join(root_dir, "unified_earlystop_comparison_runner_fd004_dualexpert_final.py"),
        os.path.join(root_dir, "unified_earlystop_comparison_runner_fd003_recipe.py"),
    ]
    found = None
    for c in candidates:
        if os.path.exists(c):
...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="FD001")
    ...
    parser.add_argument("--out_csv", type=str, default="fd001_uniform_llm_comparison.csv")
    parser.add_argument("--root_dir", type=str, default=".")
    args = parser.parse_args()

    if args.fd.upper() != "FD001":
        raise ValueError("This uniform runner is intended for FD001 only.")

    set_seed(args.seed)
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    train_file = os.path.join(args.data_dir, "train_FD001.txt")
    test_file = os.path.join(args.data_dir, "test_FD001.txt")
    rul_file = os.path.join(args.data_dir, "RUL_FD001.txt")
    ...
    feature_cols = feature_cols_fd001(train_df)
